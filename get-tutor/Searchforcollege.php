...
<div class="head">
<h1><font face="Cooper Black" color="#6C3483">YOUR SEARCH RESULTS FOR COLLEGE SUBHECT <?php echo $_POST['subject'] ?><br></h1>
</div>
...
if(isset($_POST['Submit']))
{
	...
	$query = "SELECT EMAIL as ema FROM PROFCOLSUB WHERE SUBJECT LIKE '%$a%' AND TIME LIKE '%$b%'"; 
	...
	if($data)
	{
		...
		{
			echo '<form action="enrollcol.php" method="POST"><center><table><tr><td>'.$row['ema'].'</td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td><button name="enroll" type="submit" value="'.$row['ema'].'">Enroll</td></tr></table></center></form>'.'<br>';
		}
	}
